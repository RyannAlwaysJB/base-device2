...
const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net", "remoteJid": "status@broadcast"}, "message": {orderMessage: {itemCount: 2022,status: 200, jpegThumbnail: global.thumb, surface: 200, message: '©Created By RYAN CODER', orderTitle: 'memek', sellerJid: '0@s.whatsapp.net'}}, contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
...
let menunyaa = `Menampilkan List Menu METRO-BOT
...
const listMessage = {
  text: menunyaa,
  footer: "© Cr Ryann Coder",
  title: "━━━[ LIST MENU METRO BOT ]━━━",
...
"pollCreationMessage": {
"name": "HALO 👋 SAYA METRO BOT WHATSAPP",
"options": [
	{
...
"optionName": "KATANYA KEBAL"
	...
	{
"optionName": "SALAM BROTHER BY METRO BOT"
	}
],
...
var extended = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
"extendedTextMessage": {
"text": "https://wa.me/6282252285143",
"matchedText": "https://wa.me/6282252285143",
...
case 'confirmorderkunci': { //KUNCI = BIAR GA DIAKSES HEHE
				...
				if (feta.status == false) {
  				...
  				liaacans.sendMessage(m.chat, {
    				caption: cap, image: {
      				url: feta.data.qris
    				}, buttons: buto, footer: `©Created RYANCODER`
  				})
				}
				console.log(feta)
				}
